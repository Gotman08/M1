...
def test_element_triangle():
    ...
    # Matrice de masse (condensee - formule annexe)
...
def main():
    ...
    # Test 1: Coefficients elementaires triangle
    test_element_triangle()

    # Test 2: Coefficients elementaires arete
    test_element_arete()

    # Test 3: Maillage complet m00.msh
