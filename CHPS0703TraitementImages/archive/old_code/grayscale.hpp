...
namespace Grayscale {
     ...
     */
    inline double rec601(double r, double g, double b) {
     ...
     */
    inline double rec709(double r, double g, double b) {
     ...
     */
    inline double average(double r, double g, double b) {
        return (r + g + b) / 3.0;
    }
     ...
     */
    inline double lightness(double r, double g, double b) {
     ...
     */
    inline double redChannel(double r, double /*g*/, double /*b*/) {
        return r;
    }
     ...
     */
    inline double greenChannel(double /*r*/, double g, double /*b*/) {
        return g;
    }
     ...
     */
    inline double blueChannel(double /*r*/, double /*g*/, double b) {
        return b;
    }
     ...
     * 
     * @example
     * double gray = Grayscale::convert(255, 128, 64, Grayscale::Method::REC709);
     */
    inline double convert(double r, double g, double b, Method method = Method::REC601) {
        switch (method) {
